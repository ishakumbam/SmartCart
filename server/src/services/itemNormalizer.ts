...
const categoryKeywords: Array<{ category: ItemCategory; keys: string[] }> = [
  { category: 'DAIRY', keys: ['MILK', 'CHEESE', 'YOGURT', 'EGG', 'BUTTER'] },
  { category: 'PRODUCE', keys: ['APPLE', 'BANANA', 'LETTUCE', 'TOMATO', 'ONION'] },
  { category: 'BAKERY', keys: ['BREAD', 'BAGEL', 'MUFFIN'] },
  { category: 'MEAT', keys: ['BEEF', 'CHICKEN', 'PORK', 'TURKEY'] },
  { category: 'SEAFOOD', keys: ['SALMON', 'TUNA', 'SHRIMP'] },
  { category: 'BEVERAGES', keys: ['DRINK', 'SODA', 'JUICE', 'WATER'] },
  { category: 'SNACKS', keys: ['CHIPS', 'COOKIE', 'CRACKER'] },
